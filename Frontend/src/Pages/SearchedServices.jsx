  ...
  return (
    <div className="min-h-screen bg-gray-100 px-4 py-10">
      <div className="relative mx-auto max-w-7xl">
        ...
        {/* Page Title */}
        <h1 className="mb-6 text-center text-3xl font-bold text-blue-700">Search Results</h1>
        ...
        {allProducts.length === 0 ? (
          ...
          {allProducts.map((product) => (
            <div
              key={product._id}
              className="overflow-hidden rounded-xl bg-white shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-105"
            >
              {/* Product Image */}
              <img
                src={product.images}
              ...
              <div className="p-4">
                ...
                <div className="mt-3 space-y-2">
                  <p className="flex items-center text-xl font-bold text-black">
                    💰 ₹{product.price}/
                    <span className="ml-1 text-sm opacity-65">{product.duration}</span>
                  </p>
                ...
                <div className="mt-4 flex items-center justify-end">
                  <a href={`/service/${product._id}`}>
                    <button className="rounded-lg bg-gradient-to-r from-yellow-400 to-orange-500 px-4 py-2 text-sm font-semibold text-white shadow-md hover:shadow-lg transition-all duration-300 hover:opacity-90 active:scale-95">
                      🔍 View Details
                    </button>
                  </a>
                </div>
