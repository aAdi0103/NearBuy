  ...
  return (
    <>
      ...
      <div className="max-w-5xl mt-10 mx-auto bg-white shadow-lg rounded-lg overflow-hidden border p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Product Details */}
        <div>
          <h2 className="text-2xl font-semibold text-gray-900">{service.title || "Product Title"}</h2>
          <div className="mt-4">
            <p className="text-2xl font-bold text-blue-600">
              ₹{service.price}/ <span className="text-black text-sm">{service.duration}</span>
            </p>
            ...
            <p className="text-gray-600 text-sm">
              <strong>Location:</strong> {service.location?.city}, {service.location?.state}, {service.location?.country}
            </p>
          </div>

          <p className="mt-4 text-gray-700 text-sm">{service.description || "No description available."}</p>
